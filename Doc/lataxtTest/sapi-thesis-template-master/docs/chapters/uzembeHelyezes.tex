...
hanem a kollektor-emmiter feszültség 2V körül van. Ezt a bázis feszültség
...
kapcsoltam és a tranzisztort a szaturációs pontba tettem ahol 
...
Az áramerősséget azon az értéken hagyva ahol a tranzisztor elkezdett kicsitni
...
emmiter feszültsége eléri az 1.5V-ot
...
A PNP tranzisztor esetében az emmiter konstans 3.3V-on tartásával és 
...
A mérés a következőképpen lesz látható a kijelzőn 

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.1, angle=-90]{images/results/CharDiagr.jpg}
